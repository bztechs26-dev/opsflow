...
export interface Load { id: string; number: string; area?: string; routeGroup?: string; routeRole?: LoadRouteRole; carrier: string; destination: string; destinationType?: string; equipment: string; weight: string; stops: number; pickup: string; deliveryDate?: string; deliveryTime?: string; status: LoadStatus; statusUpdatedAt?: string; dispatchedAt?: string; assignedHubTrip?: string; notes?: string; issues?: string }
export interface OperationalWeek { id: string; label: string; year?: number; organizationId?: string; productionRecords: ProductionRecord[]; loads: Load[]; machineRates?: Record<string, number>; queuePlan?: QueuePlan; tripMappings?: Record<string, string[]>; source?: 'uploaded'; uploadedAt?: string; productionFileName?: string; bulkPlanFileName?: string; fileHashes?: string[]; productionParserVersion?: number; bulkPlanParserVersion?: number }
