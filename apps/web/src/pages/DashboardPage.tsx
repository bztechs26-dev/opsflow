...
export function DashboardPage({ productionMetrics, loads, records }: Props) {
  ...
  const deliveryStatuses = ['NOT_STARTED', 'STAGED', 'LOADED', 'DISPATCHED', 'DELAYED', 'ISSUE', 'CLOSED'] as const
